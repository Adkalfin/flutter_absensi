        ...
        children: [
          ...
          Column(
            ...
            children: [
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: AssetImage(
                        'assets/images/avatar.png'), // Menggunakan AssetImage untuk gambar lokal
                  ),
                  Positioned(
                    bottom: 0,
                    right: 0,
                    child: GestureDetector(
                      onTap: () {
                        _changeProfilePhoto(
                            context); // Panggil fungsi ketika ikon edit diklik
                      },
                      child: CircleAvatar(
                        radius: 20,
              ...
              buildOptionRow('Edit Profile',
                  Icons.chevron_right), // Menggunakan ikon "chevron_right"
              buildDivider(),
              buildOptionRow('Jabatan',
                  Icons.chevron_right), // Menggunakan ikon "chevron_right"
              buildDivider(),
              buildOptionRow('Perangkat Terdaftar',
                  Icons.chevron_right), // Menggunakan ikon "chevron_right"
              buildDivider(),
            ],
          ),
